---
title: "Walter Benjamin’s Notes On Various Topics, Proximity And Distance, Part 4"
...
*The following is the fourth part of a series of translated fragments (or “short prose”) from the writings of Walter Benjamin, beginning around the time of World War I.  The first part [can be found here](/2018/06/05/walter-benjamins-notes-on-various-topics-part-1/).  The second can be found [here,](/2018/07/30/walter-benjamins-notes-on-various-topics-part-2/) the third one [here](/05/25/walter-benjamins-notes-on-various-topics-the-body-and-sexuality-part-3/).  Some of these fragments, such as the section on the famous “liar paradox” (or “Cretan paradox”) of Epimenides,  have been translated elsewhere.  Some have never been translated.   They are assembled from the German text published online by* [Der Spiegel](https://gutenberg.spiegel.de/buch/kurze-prosa-6570/5) *magazine as part of Project Gutenberg. – Ed.*
...
These are two relationships that may be decisive in the formation and life of the body, along with other special relationships – for example, up and down, left and right.  But these relationships are especially significant in the life of eros and sexuality. The erotic impulse is ignited from a distance.  On the other hand, sexuality requires proximity.. The investigations into [the dream of \[Ludwig\] Klages](https://www.jstor.org/stable/40039911?seq=1#page_scan_tab_contents) could be compared from a distance.
